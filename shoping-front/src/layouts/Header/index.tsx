...
export default function Header() {
  ...
  const UploadButton = () =>{
    ...
    // state: 게시물 상태
    const {title, content, productImageFileList, resetProduct } = useProductStore();
  ...
  useEffect(() => {
    ...
    const isProductDetailPage = pathname.startsWith(PRODUCT_PATH() + '/' +  PRODUCT_DETAIL_PATH(''));
  ...
  return (
    <div id='header'>
      ...
      <div className='header-right-box'>
        ...
        {(isAuthPage || isMainPage || isSearchPage || isProductDetailPage) && <SearchButton/>}
        {(isMainPage || isSearchPage || isProductDetailPage || isUserPage) && <MyPageButton/>}
      </div>
    </div>
  </div>
  )
